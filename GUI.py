...
button1.bind("<<Button1Click>>", lambda e: textfield.insert(END, "1"))
button2.event_add("<<Button2Click>>", "<Button-1>")
button2.bind("<<Button2Click>>", lambda e: textfield.insert(END, "2"))
button3.event_add("<<Button3Click>>", "<Button-1>")
button3.bind("<<Button3Click>>", lambda e: textfield.insert(END, "3"))
button4.event_add("<<Button4Click>>", "<Button-1>")
button4.bind("<<Button4Click>>", lambda e: textfield.insert(END, "4"))
button5.event_add("<<Button5Click>>", "<Button-1>")
button5.bind("<<Button5Click>>", lambda e: textfield.insert(END, "5"))
button6.event_add("<<Button6Click>>", "<Button-1>")
button6.bind("<<Button6Click>>", lambda e: textfield.insert(END, "6"))
button7.event_add("<<Button7Click>>", "<Button-1>")
button7.bind("<<Button7Click>>", lambda e: textfield.insert(END, "7"))
button8.event_add("<<Button8Click>>", "<Button-1>")
button8.bind("<<Button8Click>>", lambda e: textfield.insert(END, "8"))
button9.event_add("<<Button9Click>>", "<Button-1>")
button9.bind("<<Button9Click>>", lambda e: textfield.insert(END, "9"))
button10.event_add("<<Button10Click>>", "<Button-1>")
button10.bind("<<Button10Click>>", lambda e: textfield.insert(END, "+"))
